...
def calculate_mechanical_sltp(
    ...
    - R/R is determined by tp_rr_target per confidence (v40.0: HIGH=1.5, MED/LOW=1.3)
    ...
    rr_targets = mech_cfg.get('tp_rr_target', {'HIGH': 1.5, 'MEDIUM': 1.3, 'LOW': 1.3})
    rr_target = rr_targets.get(conf_key, rr_targets.get('MEDIUM', 1.8))
