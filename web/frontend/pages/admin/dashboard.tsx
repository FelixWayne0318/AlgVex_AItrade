...
function SystemInfoPanel({ token }: { token: string }) {
  ...
  const items = [
    { icon: Monitor, label: "System Version", value: info.system_version || "N/A" },
    { icon: Settings, label: "Thinking Mode", value: info.thinking_enabled ? "Enabled (v32.0)" : "Disabled" },
    { icon: Cpu, label: "Python", value: info.python_version || "N/A" },
    { icon: HardDrive, label: "NautilusTrader", value: info.nautilus_version || "N/A" },
    { icon: Monitor, label: "Web Version", value: info.web_version || "N/A" },
    ...
    { icon: Settings, label: "Environment", value: info.active_env || "production" },
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center justify-between px-3 sm:px-4 py-2 bg-background/80 backdrop-blur-xl border border-border/40 rounded-xl">
              ...
              <div className="flex items-center gap-1 sm:gap-2">
                ...
                <Button variant="ghost" size="icon" onClick={handleLogout} className="h-8 w-8 sm:w-auto sm:px-3">
          ...
          {activeTab === "strategy" && (
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                <div>
                  <h2 className="text-lg sm:text-xl font-bold">Strategy Configuration</h2>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="p-4 rounded-lg bg-muted/30 border border-border/50 space-y-3">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="font-semibold">Private Control Bot</span>
                  ...
                  <div className="p-4 rounded-lg bg-muted/30 border border-border/50 space-y-3">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="font-semibold">Community Group</span>
                    </div>
                    <p className="text-xs text-muted-foreground -mt-1">
